package azovceva.autotests.helpers;
...
public class AllureAttachments {
    ...
    public static void addBrowserConsoleLogs() {
        addMessage("Browser console logs", azovceva.autotests.helpers.DriverUtils.getConsoleLogs());
    }

    @Attachment(value = "{attachName}", type = "image/png")
    public static byte[] addScreenshotAs(String attachName) {
        return azovceva.autotests.helpers.DriverUtils.getScreenshotAsBytes();
    }

    @Attachment(value = "Page source", type = "text/html")
    public static byte[] addPageSource() {
        return azovceva.autotests.helpers.DriverUtils.getPageSourceAsBytes();
    }

    public static void addVideo(String sessionId) {
        URL videoUrl = azovceva.autotests.helpers.DriverUtils.getVideoUrl(sessionId);
        if (videoUrl != null) {
